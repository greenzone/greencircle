		...
		<div class="container">
		    <div class="row">
				...
				<div class="span3">
					...
					<script language="JavaScript" src="http://feed2js.org//feed2js.php?src=http%3A%2F%2Ffeeds.feedburner.com%2FTutorialUpdateGreenboxindonesia&num=5&targ=y&utf=y"  charset="UTF-8" type="text/javascript"></script>
					<noscript><a href="http://feed2js.org//feed2js.php?src=http%3A%2F%2Ffeeds.feedburner.com%2FTutorialUpdateGreenboxindonesia&num=5&targ=y&utf=y&html=y">View RSS feed</a></noscript>
				</div>
		    </div><!--/.row -->
		</div><!-- /.container -->
